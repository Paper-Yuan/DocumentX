    ...
    static class Program
    {
        ...
        static void Main()
        {
            try
            {
                ...
                // Installed layout first, then a launcher run straight out of a source checkout.
                // No absolute fallback: the one that used to sit here pointed at one developer's
                // machine and was compiled into every installer built from this file.
                string[] candidates = new string[]
                {
                    Path.Combine(baseDir, @"desktop_hub\server.js"),
                    Path.Combine(baseDir, @"server.js"),
                    Path.Combine(baseDir, @"apps\desktop\desktop_hub\server.js"),
                    Path.Combine(baseDir, @"..\apps\desktop\desktop_hub\server.js")
                };
