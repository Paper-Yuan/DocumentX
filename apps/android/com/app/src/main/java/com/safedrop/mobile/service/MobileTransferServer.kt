 ...
 *
 * The transport protocol mirrors apps/desktop/desktop_hub/crypto_protocol.js, so the
...
class MobileTransferServer(
     ...
     * somewhere. Mirrors `activeTransfers` in apps/desktop/desktop_hub/server.js.
     */
     ...
     * apps/desktop/desktop_hub/server.js, so a phone receiving a transfer enforces exactly what
