...
**文件路径**: `E:\Workbox\DocumentX\computer-design\tauri-app\src-tauri\src\main.rs`
...
**文件路径**: `E:\Workbox\DocumentX\computer-design\desktop_hub\public\global-shortcuts.js`
...
```bash
cd E:\Workbox\DocumentX\computer-design\tauri-app\src-tauri
cargo build --release
```
