...
async function runAllChecks() {
  ...
  const indexHtml = fs.readFileSync(path.join(__dirname, '..', '..', 'apps', 'desktop', 'desktop_hub', 'public', 'index.html'), 'utf8');
  ...
  const mainLayout = fs.readFileSync(path.join(__dirname, '..', '..', 'apps', 'android', 'com', 'app', 'src', 'main', 'res', 'layout', 'activity_main.xml'), 'utf8');
  ...
  const itemDevice = fs.readFileSync(path.join(__dirname, '..', '..', 'apps', 'android', 'com', 'app', 'src', 'main', 'res', 'layout', 'item_device.xml'), 'utf8');
