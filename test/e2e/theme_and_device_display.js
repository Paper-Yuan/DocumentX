...
const htmlPath = path.join(__dirname, '..', '..', 'apps', 'desktop', 'desktop_hub', 'public', 'index.html');
const cssPath = path.join(__dirname, '..', '..', 'apps', 'desktop', 'desktop_hub', 'public', 'style.css');
const jsPath = path.join(__dirname, '..', '..', 'apps', 'desktop', 'desktop_hub', 'public', 'app.js');
