...
const styleCss = fs.readFileSync(path.join(__dirname, '..', '..', 'apps', 'desktop', 'desktop_hub', 'public', 'style.css'), 'utf8');
...
const appJs = fs.readFileSync(path.join(__dirname, '..', '..', 'apps', 'desktop', 'desktop_hub', 'public', 'app.js'), 'utf8');
...
const mainXml = fs.readFileSync(path.join(__dirname, '..', '..', 'apps', 'android', 'com', 'app', 'src', 'main', 'res', 'layout', 'activity_main.xml'), 'utf8');
...
const mainKt = fs.readFileSync(path.join(__dirname, '..', '..', 'apps', 'android', 'com', 'app', 'src', 'main', 'java', 'com', 'safedrop', 'mobile', 'ui', 'MainActivity.kt'), 'utf8');
...
const itemMsgXml = fs.readFileSync(path.join(__dirname, '..', '..', 'apps', 'android', 'com', 'app', 'src', 'main', 'res', 'layout', 'item_channel_message.xml'), 'utf8');
...
const adapterKt = fs.readFileSync(path.join(__dirname, '..', '..', 'apps', 'android', 'com', 'app', 'src', 'main', 'java', 'com', 'safedrop', 'mobile', 'ui', 'adapter', 'ChannelMessageAdapter.kt'), 'utf8');
...
const releaseApkPath = path.join(__dirname, '..', '..', 'apps', 'android', 'SafeDrop-release.apk');
